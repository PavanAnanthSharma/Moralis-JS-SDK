...
describe('Moralis EvmApi', () => {
  ...
  it('should get pair data for a given pair address ', async () => {
    ...
    expect(result.toJSON().token0).toBe('0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c');
    expect(result.raw.token0).toBe('0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c');
    expect(result.result.token0).toBe('0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c');
  });
  ...
  it('should not get pair data for a given pair address ', async () => {
    const failedResult = await EvmApi.defi
      .getPairAddress({
        ...
        token1Address: '0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095',
        exchange: 'pancakeswapv1',
        chain: 'bsc',
      })
      .then()
